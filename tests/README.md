...
The tests run against the sample app in `app/`, which is started automatically
...
- `npm run start` starts the sample app manually at `http://127.0.0.1:3000`.

The examples use Page Object Model classes in `tests/pages/`. The spec files
